...
/*suponer identificador de reglas*/
...
/* Como hacer las preguntas y presentacion */
ask(Preguntas) :-
...
/* deshacer con si, caso contrario no en las afirmaciones*/
